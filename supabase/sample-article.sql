-- =====================================================================
-- NAVIDIX — یک مقاله‌ی آماده
--
-- کل این متن را در Supabase → SQL Editor بچسبان و Run بزن.
-- دوباره اجرا کردنش بی‌خطر است: اگر مقاله از قبل باشد به‌روزش می‌کند،
-- نه اینکه نسخه‌ی دوم بسازد.
-- =====================================================================
...
$body$,
  ...
  array['هوش مصنوعی', 'ویدیو', 'تدوین', 'پیوستگی'],

  'چرا ویدیوی AI روی نمای دوم می‌شکند',
  'مدل‌ها یک نمای درخشان می‌سازند اما نمای دوم را نمی‌توانند ادامه بدهند. سه شکل ناپیوستگی — شخصیت، نور، جهت — و اینکه امروز چه کار می‌شود کرد.',
  array['ویدیو هوش مصنوعی', 'پیوستگی', 'تدوین', 'تولید ویدیو'],
...
-- نتیجه را نشان بده
select '✓ منتشر شد — navidixstudio.com/article.html?slug=' || slug as نتیجه
from public.articles where slug = 'ai-video-continuity';
