...
--   7. cms-site.sql         — معرفی، خدمات، شبکه‌های اجتماعی
--   8. cms-comments.sql     — دیدگاه‌ها: جدول، تابع نوشتن، محدودیت نرخ، مودریشن
--   9. cms-insights.sql     — آمار: عدد کلی سایت، ثبت کلیک، صفحه‌های پربازدید
--
-- هر کدام از این ۹ تا در supabase/ فایل خودشان را هم دارند، با همان
...
-- #####################################################################
-- بخش 1 از 9 — پایه: پروفایل، پیشرفت درس، بازدید صفحه، نماهای آمار
...
-- #####################################################################
-- بخش 2 از 9 — فهرست کاربران و منابع ورودی
...
-- #####################################################################
-- بخش 3 از 9 — پاسخ به هشدارهای Advisor
...
-- #####################################################################
-- بخش 4 از 9 — نقش‌ها، Permissionها، گزارش فعالیت، تنظیمات، رسانه
...
-- #####################################################################
-- بخش 5 از 9 — مقاله، پرامپت، دوره/فصل/درس، گالری، ویدیو، جست‌وجو
...
-- #####################################################################
-- بخش 6 از 9 — دستیار هوش مصنوعی، انتشار خودکار، ورک‌فلوها
...
-- #####################################################################
-- بخش 7 از 9 — معرفی، خدمات، شبکه‌های اجتماعی
-- منبع: supabase/cms-site.sql
-- #####################################################################
...
-- #####################################################################
-- بخش 8 از 9 — دیدگاه‌ها: جدول، تابع نوشتن، محدودیت نرخ، مودریشن
-- منبع: supabase/cms-comments.sql
-- #####################################################################
...
-- #####################################################################
-- بخش 9 از 9 — آمار: عدد کلی سایت، ثبت کلیک، صفحه‌های پربازدید
-- منبع: supabase/cms-insights.sql
-- #####################################################################
