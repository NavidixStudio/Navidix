...
.lesson .forge .lab{{
  display:block; font-size:12.5px; letter-spacing:.02em; color:#7FDBD2;
...
.lesson .forge input:focus, .lesson .forge textarea:focus, .lesson .forge select:focus{{
  outline:none; border-color:#5ECEC4; background:#0D1116;
}}
...
.lesson .flip button[aria-pressed="true"]{{ color:#08090B; background:#7FDBD2; border-color:#7FDBD2; }}
