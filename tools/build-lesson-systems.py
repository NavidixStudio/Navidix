...
<section class="hero">
  <div class="wrap">
    ...
    <figure class="nvx-hero" data-nvx-zoom>
      <picture>
        <source srcset="lessons/ai-systems.webp" type="image/webp" />
        <img src="lessons/ai-systems.jpg" alt="زنجیره‌ای از چرخ‌دنده‌های فولادی روی یک ریل در سالن ماشین، با یک چراغ نشانگر سرخ در انتها" width="1600" height="685" decoding="async" />
      </picture>
