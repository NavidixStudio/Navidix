...
<meta property="og:image:alt" content="تصویر و صدا: ساختن، خواندن، شنیدن" />
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:title" content="تصویر و صدا: ساختن، خواندن، شنیدن" />
<meta name="twitter:description" content="{DESC}" />
<meta name="twitter:image" content="{IMG}" />
<meta name="twitter:image:alt" content="تصویر و صدا: ساختن، خواندن، شنیدن" />
{head_assets}
...
<section class="hero">
  <div class="wrap">
    ...
    <figure class="nvx-hero" data-nvx-zoom>
      <picture>
        <source srcset="lessons/ai-image-sound.webp" type="image/webp" />
        <img src="lessons/ai-image-sound.jpg" alt="گوشه‌ی یک استودیوی تاریک: یک سافت‌باکس بزرگ روی چهارپایه‌ای خالی، و میکروفون کندانسر روی بوم" width="1600" height="685" decoding="async" />
      </picture>
      <figcaption>پلیتِ این درس — ساخته‌شده با مدل تصویری، در همان تم تاریکِ بقیه‌ی سایت.</figcaption>
    </figure>
  </div>
</section>
