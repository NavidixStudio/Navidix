...
<section>
  <div class="wrap">
    ...
    <h2>اول این را بفهم، بقیه‌اش آسان است</h2>
    <p class="intro">بیشتر کسانی که از هوش مصنوعی ناامید می‌شوند، ابزار را بلد نبودند؟ نه. آن‌ها <b>تصور غلطی</b> از ابزار داشتند و بر اساس آن تصور، سوال غلط پرسیدند.</p>
