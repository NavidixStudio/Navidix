...
(function () {
  ...
  function styles() {
    ...
    css.textContent = [
      ...
      '.nvxs{margin:0 0 26px;padding:15px 17px;border-radius:12px;border:1px solid #2E3542;',
      '  background:#161C26;display:flex;align-items:center;gap:16px;flex-wrap:wrap;',
